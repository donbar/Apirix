...
<script language='javascript'>
  function AddNewValue(e, data){
	...
	if (thenewvalue.substr(0,2) == "np"){ // New parent - skill
		newwindow = window.open('addSkillDetail.php?type=0', "_blank", "resizable=yes, scrollbars=yes, titlebar=yes, width=500, height=400, top=10, left=10");
		}
...
<head>
  <meta charset="utf-8">
  <title>Add Skill / Alias HARD</title>
