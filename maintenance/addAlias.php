...
<script language='javascript'>
  function AddNewValue(e, data){
	...
	if (thenewvalue.substr(0,2) == "np"){ // New parent - skill
		newwindow = window.open('addSkillDetail.php', "_blank", "resizable=yes, scrollbars=yes, titlebar=yes, width=500, height=400, top=10, left=10");
		}
...
<div class="demo-section">
	<strong>Alias Maintenance Page</strong>	
	<?php
